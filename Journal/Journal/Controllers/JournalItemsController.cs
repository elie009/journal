...
namespace Journal.Controllers
{
    public class JournalItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,voucher_code,date,payee")] JournalItem journalItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,voucher_code,date,payee")] JournalItem journalItem)
        {
            if (ModelState.IsValid)
            {
